...
Background #fafafa, text #101010, 3px border-radius, 0 14px padding. The only chromatic-contrast button in the system; appears once in the nav.
...
**Carousel adaptation notes**
- Each Instagram slide is a 1080×1080 instrument panel on #101010.
- Prefer one idea per slide; use bone (#eeeeee) card only when figure/ground contrast is the point.
- Eyebrows: Geist Mono 12px uppercase with optional #ee6018 status pulse.
- No drop shadows, no purple gradients, no bold 600+ headings.
